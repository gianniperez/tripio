...
export const SetBudgetCard = ({ onSetBudget, currency, initialBudget, onCancel }: SetBudgetCardProps) => {
  const [amount, setAmount] = useState(initialBudget ? initialBudget.toString() : "");
      ...
      <div className="relative z-10 flex flex-col gap-4">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-lg font-nunito tracking-tight">Define un Presupuesto</h3>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 mt-2">
          <div className="flex items-center bg-white/10 rounded-xl px-4 py-3 backdrop-blur-sm border border-white/20 focus-within:border-white/50 transition-colors">
          ...
          <button
            ...
            className="w-full bg-white text-secondary font-bold py-3.5 rounded-xl shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-transform active:scale-95"
          >
