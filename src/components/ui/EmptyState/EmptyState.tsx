...
export const EmptyState = ({
  ...
  return (
    <NeumorphicCard className={`p-8 flex flex-col items-center gap-4 text-center ${className}`}>
      <div className="rounded-tripio flex items-center justify-center">
        <Icon name={icon || "info"} fill={true} size={48} className="text-primary-extralight" />
      </div>
